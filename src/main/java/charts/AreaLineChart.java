 ...
 */
public class AreaLineChart implements ExampleChart<XYChart>, Runnable {

    @Override
    public void run(){

        ExampleChart<XYChart> exampleChart = new AreaLineChart();
    ...
    public XYChart getChart() {
        ...
        chart.getStyler().setYAxisLabelAlignment(AxesChartStyler.TextAlignment.Left);
